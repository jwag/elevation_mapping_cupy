...
def generate_launch_description():
    ...
    core_param_path = os.path.join(share_dir, 'config', 'setups', 'real_CTL', 'parameters.yaml')
    sensor_param_path = os.path.join(share_dir, 'config', 'setups', 'real_CTL', 'sensor_GET.yaml')
